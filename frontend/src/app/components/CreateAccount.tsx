...
// Use existing auth context from the app; path is relative to src/app/components.
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm">
                {t('Join the AI-powered truth revolution')}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                type="submit"
                className="relative w-full py-3.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-semibold text-white overflow-hidden group disabled:opacity-60"
