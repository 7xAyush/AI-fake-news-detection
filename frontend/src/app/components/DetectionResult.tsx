          ...
          <div className="text-center mb-8">
            ...
            >
              ...
              <p className="text-gray-400">
                {t('AI has processed your news article')}
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              >
                ...
                <p className="text-gray-400">
                  {isReal
                    ? t('This news appears to be authentic')
                    : t('This news appears to be fabricated')}
                </p>
              </motion.div>
            </div>
