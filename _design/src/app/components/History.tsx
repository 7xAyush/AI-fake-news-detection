  ...
  const historyData = [
    {
      ...
      confidence: 94.6,
      date: '2024-02-20',
      preview: 'Government announces new environmental regulations...'
    },
    {
      id: 'NX-2024-002',
      ...
      confidence: 87.3,
      date: '2024-02-19',
      preview: 'Unverified sources claim shocking revelations...'
    },
    {
      id: 'NX-2024-003',
      title: 'Tech Giant Releases Revolutionary AI Model',
      status: 'REAL',
      confidence: 96.2,
      date: '2024-02-18',
      preview: 'Major tech company unveils groundbreaking technology...'
    },
    {
      id: 'NX-2024-004',
      title: 'Miracle Cure for Common Disease Discovered',
      status: 'FAKE',
      confidence: 92.8,
      date: '2024-02-17',
      preview: 'Dubious medical claims spread on social media...'
    },
    {
      id: 'NX-2024-005',
      title: 'Stock Market Reaches Historic High',
      status: 'REAL',
      confidence: 89.5,
      date: '2024-02-16',
      preview: 'Financial markets show record-breaking performance...'
    }
  ];
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#0a0a0f]' : 'bg-gradient-to-br from-gray-50 to-blue-50'} relative overflow-hidden p-8`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400">View all your previous news authenticity checks</p>
        </motion.div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10 bg-[#1a1a24]/50">
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">News ID</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">Status</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">Confidence</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">Date</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">News Details</th>
        ...
        >
          {[
            { label: 'Total Analyzed', value: historyData.length, color: 'cyan' },
            { label: 'Real News', value: historyData.filter(i => i.status === 'REAL').length, color: 'green' },
            { label: 'Fake News', value: historyData.filter(i => i.status === 'FAKE').length, color: 'red' }
          ].map((stat, index) => (
            <motion.div
              key={index}
