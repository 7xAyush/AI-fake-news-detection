        ...
        <div className="relative bg-[#111118]/90 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm">Login to continue detecting fake news</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                type="submit"
                className="relative w-full py-3.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-semibold text-white overflow-hidden group mt-6"
