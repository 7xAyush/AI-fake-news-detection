  ...
  const handleAnalyse = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const mockResult = {
        ...
        keywords: ['political', 'economy', 'health', 'science'],
        analyzedAt: new Date().toISOString()
      };
      
      onAnalyse(mockResult);
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#0a0a0f]' : 'bg-gradient-to-br from-gray-50 to-blue-50'} relative overflow-hidden p-8`}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleAnalyse} className="relative z-10 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Paste the full article text or URL here for analysis..."
                />
              </div>
        ...
        >
          {[
            { label: 'AI-Powered', value: '99.2%', desc: 'Accuracy' },
            { label: 'Real-time', value: '<2s', desc: 'Analysis' },
            { label: 'Sources', value: '10M+', desc: 'Verified' }
          ].map((stat, index) => (
            <motion.div
              key={index}
